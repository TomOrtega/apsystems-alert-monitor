    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button onClick={async () => { setTesting(true); setMsg(''); try { await api.testSmtp(); setMsg('Email de prueba enviado correctamente'); } catch (e) { setMsg('Error: ' + e.message); } setTesting(false) }} disabled={testing} className="btn-secondary flex items-center gap-2">
            <TestTube size={16} /> {testing ? 'Enviando...' : 'Probar envio'}
          </button>
